...
import { extractTextFromPDF, parseNursingText, extractContentionGroups } from "@/lib/importParser";
...
export default function ImportContentionModal({ open, onOpenChange, residents, onImport }) {
  ...
  const handleConfirmImport = async () => {
    ...
    if (toProcess.length === 0) {
      alert("Associez au moins un résident avant de valider");
      return;
    }
              ...
              <div className="flex gap-2">
                <Button
                  onClick={() => {
                    ...
                    setKeywords(JSON.parse(JSON.stringify(DEFAULT_KEYWORDS)));
            ...
            <div className="flex gap-2 pt-4 border-t">
              ...
              >
                {loading ? (
                  ...
                  <><CheckCircle2 className="h-4 w-4" /> Valider l'import</>
                )}
              </Button>
